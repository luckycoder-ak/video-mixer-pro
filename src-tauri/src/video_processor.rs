...
fn create_transition_effect(
    ...
    let filter_complex = match transition_type {
        "fade" => format!(
            "[0:v]trim=0:{},setpts=PTS-STARTPTS,settb=AVTB,fps=30[v0];[1:v]trim={}:,setpts=PTS-STARTPTS+{}/TB,settb=AVTB,fps=30[v1];[v0][v1]xfade=transition=fade:duration={}:offset={}[final]",
            half_duration_str, half_duration_str, half_duration_str, duration_str, half_duration_str
        ),
        "dissolve" => format!(
            "[0:v]trim=0:{},setpts=PTS-STARTPTS,settb=AVTB,fps=30[v0];[1:v]trim={}:,setpts=PTS-STARTPTS+{}/TB,settb=AVTB,fps=30[v1];[v0][v1]xfade=transition=dissolve:duration={}:offset={}[final]",
            half_duration_str, half_duration_str, half_duration_str, duration_str, half_duration_str
        ),
        "wipeleft" => format!(
            "[0:v]trim=0:{},setpts=PTS-STARTPTS,settb=AVTB,fps=30[v0];[1:v]trim={}:,setpts=PTS-STARTPTS+{}/TB,settb=AVTB,fps=30[v1];[v0][v1]xfade=transition=wipeleft:duration={}:offset={}[final]",
            half_duration_str, half_duration_str, half_duration_str, duration_str, half_duration_str
        ),
        "wiperight" => format!(
            "[0:v]trim=0:{},setpts=PTS-STARTPTS,settb=AVTB,fps=30[v0];[1:v]trim={}:,setpts=PTS-STARTPTS+{}/TB,settb=AVTB,fps=30[v1];[v0][v1]xfade=transition=wiperight:duration={}:offset={}[final]",
            half_duration_str, half_duration_str, half_duration_str, duration_str, half_duration_str
        ),
        "wipeup" => format!(
            "[0:v]trim=0:{},setpts=PTS-STARTPTS,settb=AVTB,fps=30[v0];[1:v]trim={}:,setpts=PTS-STARTPTS+{}/TB,settb=AVTB,fps=30[v1];[v0][v1]xfade=transition=wipeup:duration={}:offset={}[final]",
            half_duration_str, half_duration_str, half_duration_str, duration_str, half_duration_str
        ),
        "wipedown" => format!(
            "[0:v]trim=0:{},setpts=PTS-STARTPTS,settb=AVTB,fps=30[v0];[1:v]trim={}:,setpts=PTS-STARTPTS+{}/TB,settb=AVTB,fps=30[v1];[v0][v1]xfade=transition=wipedown:duration={}:offset={}[final]",
            half_duration_str, half_duration_str, half_duration_str, duration_str, half_duration_str
        ),
        "hblur" => {
            let blur_val = "10:0".to_string();
            format!(
                "[0:v]trim=0:{},setpts=PTS-STARTPTS,settb=AVTB,fps=30,boxblur={}[v0];[1:v]trim={}:,setpts=PTS-STARTPTS+{}/TB,settb=AVTB,fps=30,boxblur={}[v1];[v0][v1]xfade=transition=fade:duration={}:offset={}[final]",
